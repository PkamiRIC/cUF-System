...
def run_elution(
    *,
    ...
    """Legacy-style Elution sequence from MainGUI_v5 flow."""

    def _log(msg: str) -> None:
        if log:
            log(msg)

    _log("Elution: set collect valve")
    set_relay(7, False)
    set_relays([2, 6], True)
    ...
    try:
        ...
        _log("Elution: disable pump and close relays")
        set_pump_enabled(False)
        set_relays([2, 6], False)
        # Reset to default non-collect state
        set_relay(7, True)
